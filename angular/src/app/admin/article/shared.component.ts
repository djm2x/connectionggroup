...
export class SharedComponent implements OnInit {
  ...
  add() {
    this.openDialog(new President(), 'Ajouter Mot de président').subscribe(result => {
      if (result) {
  ...
  edit(o: President) {
    this.openDialog(o, 'Modifier Mot de président').subscribe((result: President) => {
      if (result) {
        this.update.next(true);
      }
    });
