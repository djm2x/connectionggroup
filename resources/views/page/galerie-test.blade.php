        ...
        <div class="row">
            <div class="row">
                ...
                @foreach ($images as $e)
                    ...
                    <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                    <a class="thumbnail" href="#" data-image-id="{{$loop->iteration}}" data-toggle="modal" data-title="{{$e}}"
                           data-image="{{url('blogs/'.$model->id.'/'.$e)}}"
                           data-target="#image-gallery">
                            <img class="img-thumbnail"
                                 src="{{url('blogs/'.$model->id.'/'.$e)}}" onerror="this.onerror=null;this.src='/images/404.png';"
                                 alt="Another alt text">
                        </a>
                    </div>
                @endforeach
            ...
            <div class="modal fade" id="image-gallery" style="margin-top: 40px;" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <img id="image-gallery-image" class="img-responsive col-md-12" src="" onerror="this.onerror=null;this.src='/images/404.png';">
                        </div>
    ...
    function loadGallery(setIDs, setClickAttr) {
      let current_image, selector, counter = 0;
        ...
        function updateGallery(selector) {
            ...
            $('#image-gallery-image').attr('onerror', this.onerror=null;this.src='/images/404.png';);
